...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		buffer.append("			</li> \n");
		buffer.append("			<li class=\"page-item\" data-pg=\"" + (this.startRange ? 1 : (this.currentPage - 1)) + "\"> \n");
		...
		buffer.append("			<li class=\"page-item\" data-pg=\"" + (this.endRange ? endPage : (this.currentPage + 1)) + "\"> \n");
